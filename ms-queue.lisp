...
(defmethod scan-and-split ((item resource) (queue list))
  (cond ((null queue) queue)
        ((and (< (best-start-time (car queue)) (best-end-time item))
...
(defmethod scan-and-split ((item resource) (queue resource-queue))
  (setf (resource-queue-tree queue) (scan-and-split item (resource-queue-tree queue)))
)
